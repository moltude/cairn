...
### Inputs
- **GPX**: `/Users/scott/downloads/onx-markups-12142025.gpx`
- **KML**: `/Users/scott/downloads/onx-markups-12142025 (1).kml`

### Outputs
- **Primary (deduped)**: `caltopo_ready/most_usable.json`
- **Secondary (dropped duplicates)**: `caltopo_ready/most_usable_dropped_shapes.json`
